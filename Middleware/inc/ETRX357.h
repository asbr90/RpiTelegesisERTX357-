...
#define ATDREQ			"AT+IDREQ"		/**< Request Nodeâ€™s Network address (ZDO)*/
#define ATEUIREQ		"AT+EUIREQ"		/**<Request Nodeâ€™s EUI (ZDO)*/
#define ATNODEDESC		"AT+NODEDESC"	/**<Request Nodeâ€™s Descriptor (ZDO)*/
#define ATPOWERDESC 	"AT+POWERDESC"	/**<Request Nodeâ€™s Power Descriptor (ZDO)*/
#define ATACTEPDESC		"AT+ACTEPDESC"	/**< Request Nodeâ€™s Active Endpoint List (ZDO)*/
#define ATSIMPLEDESC	"AT+SIMPLEDESC"	/**< Request Endpointâ€™s Simple Descriptor (ZDO)*/
...
#define ATCCHANGE		"AT+CCHANGE"	/**<Change the networkâ€™s channel*/
 ...
 */
 char* DisplayNeighbourTable(char*);

char* RequestEndpointSimpleDescriptor(char*);
char* RequestNodesActiveEndpoints(char*);
...
char* ColourControlMoveToColour(char* );
/** @} */ // CFS
/** @} */// end of functions
#endif

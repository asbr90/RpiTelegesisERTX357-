...
SOURCES= Hardware/src/serialDriver.c  src/main.c Middleware/src/ATParser.c Middleware/src/ETRX357.c Middleware/src/LUT.c Middleware/src/PhilipsHUE.c Middleware/src/PowerSocket.c
DISTDIR= bin/
ODIR=obj
ODIRMID=Middleware/
ODIRHWD=Hardware/
